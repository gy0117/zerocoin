...
func (c *registerClient) RegisterByPhone(ctx context.Context, in *RegisterReq, opts ...grpc.CallOption) (*RegisterResp, error) {
...
func (c *registerClient) SendCode(ctx context.Context, in *CodeReq, opts ...grpc.CallOption) (*CodeResp, error) {
	out := new(CodeResp)
...
type RegisterServer interface {
	RegisterByPhone(context.Context, *RegisterReq) (*RegisterResp, error)
	SendCode(context.Context, *CodeReq) (*CodeResp, error)
...
func (UnimplementedRegisterServer) RegisterByPhone(context.Context, *RegisterReq) (*RegisterResp, error) {
	return nil, status.Errorf(codes.Unimplemented, "method RegisterByPhone not implemented")
}
func (UnimplementedRegisterServer) SendCode(context.Context, *CodeReq) (*CodeResp, error) {
...
func _Register_RegisterByPhone_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(RegisterServer).RegisterByPhone(ctx, req.(*RegisterReq))
	}
