...
func (c *userClient) FindUserById(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*UserInfoResp, error) {
...
type UserServer interface {
	FindUserById(context.Context, *UserRequest) (*UserInfoResp, error)
...
func (UnimplementedUserServer) FindUserById(context.Context, *UserRequest) (*UserInfoResp, error) {
...
func _User_FindUserById_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).FindUserById(ctx, req.(*UserRequest))
	}
