...
type ExchangeRateClient interface {
	UsdRate(ctx context.Context, in *RateRequest, opts ...grpc.CallOption) (*RateResponse, error)
}
...
func (c *exchangeRateClient) UsdRate(ctx context.Context, in *RateRequest, opts ...grpc.CallOption) (*RateResponse, error) {
...
type ExchangeRateServer interface {
	UsdRate(context.Context, *RateRequest) (*RateResponse, error)
...
func (UnimplementedExchangeRateServer) UsdRate(context.Context, *RateRequest) (*RateResponse, error) {
...
func _ExchangeRate_UsdRate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ExchangeRateServer).UsdRate(ctx, req.(*RateRequest))
	}
